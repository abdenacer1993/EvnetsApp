                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Liste Postes</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td name="nom_prop_salle"><?php echo $donnees['nom_prop_salle'] ?></td>
                                                        <td name="type_event"><?php echo $donnees['type_event'] ?></td>
                                                        <td name="image"><img src="Controller/<?php echo $donnees['images'] ?>" width="150" heigth="150"></td>

                                                        <td name="numtel_salle"><?php echo $donnees['numtel_salle'] ?></td>
                                                        <?php
                                                        if ($donnees['etat'] == 'En cour...') {
                                                        ?>
                                                            <td name="etat" style="color:gold"><?php echo $donnees['etat'] ?></td>
                                                        <?php
                                                        } else { ?>
                                                            <td name="etat" style="color:green"><?php echo $donnees['etat'] ?></td>
                                                        <?php
                                                        } ?>
                                                        <td><a href="Controller/AccepterPoste.php?id=<?php echo $donnees['id'] ?>" class="btn btn-success waves-effect waves-light">Accepter</a>

                                                            <a href="Controller/SupprimerPoste.php?id=<?php echo $donnees['id'] ?>" class="btn btn-danger waves-effect waves-light">Supprimer</a>
