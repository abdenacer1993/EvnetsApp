...
$localisation = "../../p-admin/Controller/upload/";
...
$Postes = new Postes($_POST['nom_salle'],$_POST['nom_prop_salle'],$_POST['type_event'],$chemin,$_POST['numtel_salle'],'En cour...',$id_a);
$Postes->ajouter();

header("location:../ajouterPosteClient.php?Ajout=oui");
?>