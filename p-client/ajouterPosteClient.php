                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="wow fadeInUp" data-wow-delay="0.5s">
                                <p class="mb-4"></p>
                                <form method="POST" action="Controller/AjoutPoste.php" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <?php
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" required="required" name="nom_salle" id="name" placeholder="Nom & prénom">
                                                <label for="name">Nom de la salle</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" required="required" name="nom_prop_salle" id="email" value="<?php echo $donnees['nom'] ?>">
                                                <label for="email">Nom propriétaire</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" required="required" name="numtel_salle" id="name" placeholder="Nom & prénom">
                                                <label for="name">Numéro de propriétaire</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <select class="form-select" id="floatingSelect" name="type_event" aria-label="Floating label select example">
