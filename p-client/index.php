...
$req = $bdd->query("SELECT * FROM postes where etat = 'Accpter' ");
//$req2 = $bdd->query("SELECT * FROM postes where type_event = $nom_cat and etat = 'Accpter' ");
                    ...
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                ...
                                <a href="contact.php" class="btn btn-primary py-3 px-4 me-2"><i class="fa fa-columns me-2"></i>Par compte</a>
                                <a href="mailto:adresse@example.com" class="btn btn-dark py-3 px-4"><i class="fa fa-mail-bulk me-2"></i>Par email</a>
                            </div>
                        </div>
                    </div>
                </div>
